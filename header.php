...
<body <?php body_class(); ?>>
    ...
    <div class="container max-w-8xl mx-auto">
      <div class="grid grid-cols-12 gap-4 px-4">
        ...
        <!-- Hamburger Button -->
        <div class="col-span-6 sm:col-span-6 md:col-span-9 flex items-center justify-end md:hidden">
        ...
        <div class="col-span-6 hidden md:flex justify-center items-center">
          <ul class="flex space-x-6">
            <li class="text-lg font-semibold"><a href="<?php echo esc_url(home_url('/')); ?>" class="nav-link  text-gray-700 hover:text-gray-900">Home</a></li>
            <li class="text-lg font-semibold"><a href="<?php echo site_url('/features'); ?>" class="nav-link text-gray-700 hover:text-gray-900">Features</a></li>
            <li class="text-lg font-semibold"><a href="<?php echo site_url('/pricing'); ?>" class="nav-link text-gray-700 hover:text-gray-900">Pricing</a></li>
            <li class="relative group text-lg font-semibold">
  <!-- Trigger -->
  ...
  <div class="desktop-dropdown invisible opacity-0 transition-all duration-300 absolute left-1/2 -translate-x-1/2 top-[3rem] w-screen max-w-[32rem] z-50 rounded-xl bg-white border-y-[8px]  border-[#bfdbfe] shadow-lg">
    ...
    <div class="flex justify-between items-center bg-[#f9fbff] px-6 py-4 rounded-b-xl">
      ...
      <a href="tel:+16187229189" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition">
        ...
        <div class="col-span-3 md:flex items-center justify-end space-x-2 hidden">
