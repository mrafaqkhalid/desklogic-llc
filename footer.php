        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="0">
                ...
                <div class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                    ...
                    <a href="https://x.com/DeskLogic16925" class="w-9 h-9 rounded-full bg-[var(--app-1)] hover:bg-[var(--app-2)] transition duration-300 ease-in-out flex justify-center items-center ">
                    ...
                    <a href="https://www.linkedin.com/in/desklogicinspectionsoftware" class="w-9 h-9 rounded-full bg-[var(--app-1)] hover:bg-[var(--app-2)] transition duration-300 ease-in-out flex justify-center items-center ">
                        <svg class="w-[1rem] h-[1rem] text-white" viewBox="0 0 13 12" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.tiktok.com/@desklogic" class="w-9 h-9 rounded-full bg-[var(--app-1)] hover:bg-[var(--app-2)] transition duration-300 ease-in-out flex justify-center items-center ">
                        <svg class="w-[1rem] h-[1rem] text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="py-8 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                ...
                <ul class="flex items-center gap-9 mt-4 lg:mt-0">
                    ...
                    <li><a class="text-sm text-gray-500" href="<?php echo esc_url( home_url( '/privacy-policy' ) ); ?>">Privacy</a></li>
                    <li><a class="text-sm text-gray-500" href="<?php echo esc_url( home_url( '/cookie-policy' ) ); ?>">Cookies</a></li>
                </ul>
                <div class="flex items-center justify-end">
                    <ul class="flex max-w-[280px] mt-8 md:mt-0">
                        <li class="mr-2">
                            <a href="https://apps.apple.com/us/app/desklogic/id6499438887" target="_blank" rel="noopener">
                                <img alt="iOS App" loading="lazy" width="556" height="164" decoding="async" data-nimg="1" class="img-fluid" src="https://www.desklogic.com/_next/static/media/ios.d84ddd85.svg" style="color: transparent;">
                            </a>
                        </li>
                        <li>
                            <a href="https://play.google.com/store/apps/details?id=com.desklogicmobile" target="_blank" rel="noopener">
                                <img alt="Android App" loading="lazy" width="556" height="164" decoding="async" data-nimg="1" class="img-fluid" src="https://www.desklogic.com/_next/static/media/android.0e7c63ee.svg" style="color: transparent;">
                            </a>
                        </li>
                    </ul>
                </div>
