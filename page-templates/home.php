            ...
            <div class="flex justify-center">
                <div class="w-full md:w-12/12">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="p-6 md:p-12 bg-white rounded-[20px] grid aos-init" data-aos="fade-up"
                            data-aos-delay="200">
                            ...
                            <div class="left">
                                <h3 class="text-2xl font-semibold mb-2">Detailed Reporting</h3>
                                <p class=" mt-2 text-[1.1rem]">Instantly generate detailed and customizable
                        ...
                        <div class="p-6 md:p-12 bg-white rounded-[20px] grid aos-init" data-aos="fade-up"
                            ...
                            <div class="left">
                                ...
                                <p class=" mt-2 text-[1.1rem]">Access and update inspection data in real-time from
                                    any device anywhere with no additional charges.</p>
                            </div>
                        </div>
                        <div class="p-6 md:p-12 bg-white rounded-[20px] grid aos-init" data-aos="fade-up"
                            data-aos-delay="400">
                            ...
                            <div class="left">
                                <h3 class="text-2xl font-semibold mb-2">Seamless Scheduling</h3>
                                <p class=" mt-2 text-[1.1rem]">Schedule inspections, manage appointments, and
                                    assigning multiple inspectors is a breeze.</p>
                            </div>
                        </div>
                        <div class="p-6 md:p-12 bg-white rounded-[20px] grid aos-init" data-aos="fade-up"
                            data-aos-delay="500">
                            ...
                            <div class="left">
                                <h3 class="text-2xl font-semibold mb-2">Cost-Effective</h3>
                                <p class=" mt-2 text-[1.1rem]">Top-notch features at an affordable price, ideal for
                                    home inspectors.</p>
                            </div>
                        </div>
                    </div>
